...
import { FileText, Search, Loader2, Building2, Calendar, Filter, ArrowUpDown } from 'lucide-react'
  ...
  const filteredInvoices = invoices
    .filter(inv => {
      const matchesSearch = inv.invoiceNumber.toLowerCase().includes(searchTerm.toLowerCase()) ||
        inv.supplier?.companyName.toLowerCase().includes(searchTerm.toLowerCase())
          ...
          <CardContent className="py-8">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-4xl font-bold text-green-600 mt-2">{formatPrice(totalCommission)}</p>
              </div>
            ...
            <table className="w-full border-collapse">
              <thead>
                <tr className="bg-gray-50 border-b-2 border-gray-200">
                  ...
                  <th className="text-left px-6 py-4 text-sm font-bold text-gray-700 whitespace-nowrap">공급자</th>
                  ...
                  <th className="text-center px-6 py-4 text-sm font-bold text-gray-700 whitespace-nowrap">상태</th>
                ...
                {filteredInvoices.map((invoice) => {
                  ...
                  return (
                    <tr key={invoice.id} className="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                      ...
                      <td className="px-6 py-4">
                        <span className="text-gray-900 whitespace-nowrap">{invoice.supplier?.companyName}</span>
                      </td>
