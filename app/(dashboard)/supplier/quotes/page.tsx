...
export default function SupplierQuotesPage() {
  ...
  return (
    <div className="space-y-8">
      {/* 페이지 헤더 */}
      <div>
        <h1 className="text-3xl font-bold text-gray-900 break-keep">보낸 제안</h1>
        <p className="text-lg text-gray-500 mt-1 break-keep">제출한 제안의 상태를 확인하세요</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <Card className="hover:shadow-lg transition-shadow">
          <CardContent className="py-8">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-lg text-gray-500 whitespace-nowrap">대기중</p>
        ...
        <Card className="hover:shadow-lg transition-shadow">
          <CardContent className="py-8">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-lg text-gray-500 whitespace-nowrap">수락됨</p>
        ...
        <Card className="hover:shadow-lg transition-shadow">
          <CardContent className="py-8">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-lg text-gray-500 whitespace-nowrap">총 제안 금액</p>
        ...
        <Card className="hover:shadow-lg transition-shadow">
          <CardContent className="py-8">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-lg text-gray-500 whitespace-nowrap">총 제안</p>
              ...
              return (
                <Card key={quote.id} className={`hover:shadow-xl transition-all cursor-pointer h-full ${quote.status === 'accepted' ? 'border-green-300 bg-green-50/50' : ''}`}>
                  <CardContent className="py-6">
                    ...
                    {/* 제목 */}
                    <h3 className="text-2xl font-bold text-gray-900 mb-4 break-keep">{quote.rfq?.title}</h3>
